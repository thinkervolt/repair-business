...
@section('page-content') 
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h1 class="h3 mb-0 text-primary">Stock {{ ($product->transactions->where('transaction', 'purchase')->sum('quantity')) - ($product->transactions->where('transaction', 'sell')->sum('quantity')) }}</h1>
                     ...
                     <form action="{{route('inventory-update-product',$product)}}" method="POST">
                        ...
                        <div class="form-group row m-0">
                            ...
                            <div class="form-group row m-0">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" id="name" value="{{ $product->name }}" name="name" placeholder="">
                                @error('name')
                                    <span class="invalid-feedback mb-1" role="alert">
                                    {{ $message }}
                                    </span>
                            ...
                            <div class="form-group row m-0">
                                ...
                                <div class="col-sm-10">
                                <input type="number" class="form-control form-control-sm @error('min_stock') is-invalid @enderror" id="min_stock" value="{{$product->min_stock}}" name="min_stock" placeholder="">
                                @error('min_stock')
                                    <span class="invalid-feedback mb-1" role="alert">
                                    {{ $message }}
                                    </span>
                            ...
                            <div class="form-group row m-0">
                                ...
                                <div class="col-sm-10">
                                <input type="number" class="form-control form-control-sm @error('max_stock') is-invalid @enderror" id="max_stock" value="{{$product->max_stock}}" name="max_stock" placeholder="">
                                @error('max_stock')
                                    <span class="invalid-feedback mb-1" role="alert">
                                    {{ $message }}
                                    </span>
