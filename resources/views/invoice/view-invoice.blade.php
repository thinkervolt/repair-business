        ...
        <div class="card ">
            ...
            <div class="col-sm">
                <a href="{{ route('index-repair', [($task = 'invoice'), $invoice]) }}"
                    class="btn btn-primary btn-sm btn-block mb-1"><i class="fas fa-plus"></i> Repair</a>
            </div>
            <div class="col-sm">
                <a href="{{ route('inventory-index-product', [($task = 'invoice'), $invoice]) }}"
                    class="btn btn-primary btn-sm btn-block mb-1"><i class="fas fa-plus"></i> Product</a>
            </div>
            <div class="col-sm">
            ...
            <div class="col-sm">
              ...
              <a href="{{ route('print-invoice', [$invoice, 'receipt']) }}" class="btn btn-primary btn-sm btn-block mb-1"
                  target="popup"
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <input type="text" class="form-control form-control-sm" name="unit_cost"
                                        placeholder="Unit Cost" value="{{ $item->unit_cost }}">
                                </td>
                                <td class="center">
                    ...
                    <tr>
                        ...
                        <td class="left">
                            ...
                            <input type="text" class="form-control form-control-sm" name="sub_description"
                                placeholder="Item Sub-Description" value="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @if (isset($payment->ref))
                                            <p class="text-muted small text-uppercase m-0 p-0"> REF: {{ $payment->ref }}
                                            </p>
                                        @endif
