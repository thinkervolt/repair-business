...
@section('page-content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{ __('form.settings') }}</h1>
        </div>
        <div class="row">
            <div class="col">
                @if (!$settings->isEmpty())
                        ...
                        <table class="table table-sm mt-3 ">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">{{ __('table.group') }}</th>
                                    <th scope="col">{{ __('table.value') }}</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach ($settings as $setting)
                                    <form method="POST" action="{{ route('update-setting', $setting) }}">
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-warning "><i class="fas fa-edit"></i> {{ __('button.update') }}</button></td>
                                        </tr>
                                    </form>
                                @endforeach
                            </tbody>
