    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-secondary sidebar sidebar-dark accordion @if (Session::has('sidebar-position')) @if (Session::get('sidebar-position') == 'close') toggled @endif @endif "
            ...
            <li class="nav-item">
                ...
                <div id="collapseRepairs" class="collapse" aria-labelledby="collapseRepairs"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div id="collapseInvoices" class="collapse" aria-labelledby="collapseInvoices"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                @if (Session::has('sidebar-position'))
                    @if (Session::get('sidebar-position') == 'close')
                        <a href="{{ route('set-sidebar-position', 'open') }}"
                            class="rounded-circle border-0 text-light">
                            <i class="fas fa-chevron-right"></i>
                        </a>
                    @endif
                    @if (Session::get('sidebar-position') == 'open')
                        <a href="{{ route('set-sidebar-position', 'close') }}"
                            class="rounded-circle border-0 text-light">
                ...
                @else
                    <a href="{{ route('set-sidebar-position', 'close') }}"
                        class="rounded-circle border-0 text-lightk">
                        <i class="fas fa-chevron-left"></i>
                    </a>
                @endif
            </div>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                @if (isset($notifications_count))
                                    @if ($notifications_count > 0)
                                        <span
                                            class="badge badge-danger badge-counter">{{ $notifications_count }}</span>
                                    @endif
                                @endif
                            </a>
                            <!-- Dropdown - Alerts -->
