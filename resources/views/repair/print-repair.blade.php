...
<div class="print-area-container">
    ...
    <div class="data-block">
        ...
        <p class="data-line left">{{preg_replace("/^(\d{3})(\d{3})(\d{4})$/", "$1-$2-$3", $company_profile->phone)}}</p>
    ...
    <div class="data-block">
        ...
        <p class="data-line">{{preg_replace("/^(\d{3})(\d{3})(\d{4})$/", "$1-$2-$3", $repair->customer_data->phone)}}</p>
        <p class="data-line">{{$repair->customer_data->email}}</p>
        <p class="data-line">{{$repair->customer_data->address}} {{$repair->customer_data->city}} {{$repair->customer_data->state}} {{$repair->customer_data->zip}}</p>
        @endif
    </div>
    ...
    <div class="data-block">
        @if(isset($repair->estimate))<p class="big-data-line right">Estimate ${{ number_format((float)$repair->estimate, 2, '.', '') }}</p>@endif
    </div>
