...
@section('page') View Repair @endsection
            ...
            <div class="row justify-content-md-center ">
                ...
                @if(isset($repair->customer))
                    ...
                    <div class="card shadow  py-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->customer_data->first_name ?? ''}} {{$repair->customer_data->last_name ?? ''}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{preg_replace("/^(\d{3})(\d{3})(\d{4})$/", "$1-$2-$3", $repair->customer_data->phone ?? '')}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->customer_data->email ?? ''}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->customer_data->address ?? ''}} {{$repair->customer_data->city ?? ''}} {{$repair->customer_data->state ?? ''}} {{$repair->customer_data->zip ?? ''}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->customer_data->company ?? ''}}</div>
                            </div>
                ...
                @endif
                    ...
                    <div class="card shadow  py-2 mt-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">AGENT</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->agent_data->name ?? ''}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->agent_data->email ?? ''}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$repair->agent_data->role ?? ''}}</div>
                    ...
                    <div class="card shadow  py-2 mt-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">INFORMATION</div>

                            @if(isset($repair->status))
                            <div class="h5 mb-0 font-weight-bold text-{{$repair->status_data->color ?? ''}}">STATUS: {{$repair->status_data->name ?? ''}}</div>
                            @endif
                            @if(isset($repair->priority))
                            <div class="h5 mb-0 font-weight-bold text-{{$repair->priority_data->color ?? ''}}">PRIORITY: {{$repair->priority_data->name ?? ''}}</div>
                            @endif
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">REPAIR</div>
                                    ...
                                    <!-- FORM -->
                                        <form action="{{route('update-repair',$repair)}}" method="POST">
                                            ...
                                            @method('PUT')
                                                ...
                                                <div class="form-group row m-0">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input type="text" class="form-control form-control-sm @error('target') is-invalid @enderror" id="target" value="{{$repair->target}}" name="target" placeholder="">
                                                    @error('target')
                                                ...
                                                <div class="form-group row m-0">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control form-control-sm @error('data_request') is-invalid @enderror" id="data_request"   value="{{$repair->request}}"  name="data_request" placeholder="">
                                                        @error('data_request')
                                                        <span class="invalid-feedback mb-1" role="alert">
                                                        {{ $message }}
                                                        </span>
                                                ...
                                                <div class="form-group row m-0">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control form-control-sm @error('user') is-invalid @enderror" name="user">
                                                            <option  @if($repair->user === null) selected @endif ></option>
                                                            @if(!$users->isEmpty())
                                                                @foreach($users as $user)
                                                                <option value="{{$user->id}}" @if($repair->user === $user->id) selected @endif > {{$user->name}} </option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('user')
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control form-control-sm @error('status') is-invalid @enderror" name="status">
                                                            ...
                                                            @if(!$statuses->isEmpty())
                                                                ...
                                                                <option value="{{$status->id}}" @if($repair->status == $status->id) selected @endif > {{$status->name}} </option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('status')
                                                ...
                                                <div class="form-group row m-0">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control form-control-sm @error('priority') is-invalid @enderror" name="priority">
                                                            <option  @if($repair->priority === null) selected @endif ></option>
                                                            @if(!$priorities->isEmpty())
                                                                @foreach($priorities as $priority)
                                                                <option value="{{$priority->id}}" @if($repair->priority == $priority->id) selected @endif > {{$priority->name}} </option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('priority')
                                                ...
                                                <div class="form-group row m-0">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control form-control-sm @error('estimate') is-invalid @enderror" id="estimate"   value="{{ number_format((float)$repair->estimate, 2, '.', ',') }}"  name="estimate" placeholder="0.00">
                                                        @error('estimate')
                                                        <span class="invalid-feedback mb-1" role="alert">
                                                        {{ $message }}
                                                        </span>
                                            ...
                                            <div class="form-group row m-0">
                                                    <div class="col-sm-2"> </div>
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-block btn-danger mt-3 mb-2 btn-sm"><i class="fa fa-trash"></i> Delete</button>
                                                    </div>
                                                </div>
                                            </form>
                                        <!-- END FORM -->
                                        ...
                                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">JOBS & COMMENTS</div>
...
<form action="{{route('create-item-repair',$repair)}}" method="POST">
    @csrf
        ...
        <div class="form-group row m-0">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control form-control-sm @error('data') is-invalid @enderror" id="data" value="{{old('data')}}" name="data" placeholder="">
            @error('data')
                <span class="invalid-feedback mb-1" role="alert">
                   {{ $message }}
                </span>
        ...
        <div class="form-group row m-0">
            ...
            <div class="col-sm-10">
                <select class="form-control form-control-sm @error('group') is-invalid @enderror" name="group">
